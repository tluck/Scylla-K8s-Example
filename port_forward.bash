...
printf  "\nGrafana credentials: \n\thttps://scylla-grafana:33000 \n\tUsername: ${username} \n\tPassword: ${password} \n\n"

if [[ ! -z ${username} ]]; then
  printf "Port-forward service/${clusterName}-grafana 33000:3000\n"
  kubectl -n ${clusterNamespace} port-forward service/${clusterName}-grafana 33000:3000 > /dev/null 2>&1 &
