...
curl -sq -X GET "http://scylla-client:10000/storage_service/estimate_compression_ratios?keyspace=${keyspace}&cf=${table}" | jq '.[] | select(.chunk_length_in_kb == 16 and (.dict == "past" or .dict == "none") and .level == 5)'
