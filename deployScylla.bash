...
if [[ ${helmEnabled} == true ]]; then
  ...
  kubectl -n ${scyllaNamespace} delete -f ${custerName}.ScyllaDBMonitoring.yaml
...
cat ${templateFile} | sed \
    ...
    -e "s|BROADCASTNODETYPE|${broadcastNodeType}|g" \
    -e "s|BROADCASTCLIENTTYPE|${broadcastClientsType}|g" \
