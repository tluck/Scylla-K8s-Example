...
data:
  scylla.yaml: |
    ...
    client_encryption_options:
      ...
      ${cust_crts}certificate: /var/run/secrets/${clusterName}-client-certs/tls.crt
      ${cust_crts}keyfile:     /var/run/secrets/${clusterName}-client-certs/tls.key
      ${cust_crts}truststore:  /var/run/secrets/${clusterName}-server-certs/ca.crt
      # these certs and keys are generated by the operator and sent to client
      ...
      # operator CA bundle to validate client certs
      ${oper_crts}truststore:  /var/run/configmaps/scylla-operator.scylladb.com/scylladb/client-ca/ca-bundle.crt
